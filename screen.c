...
void screen_draw_layout(void) {
  ...
  screen_draw_box(0, 0, 50, 80, 0x00, 2);

  screen_draw_box(5, 5, 7, 25, '*', 2);
  screen_draw_box(6, 6, 5, 23, 0x00, 2);

  print("Martin Sinnona", 10, 7, 3);
  print("Mariano Pironio", 10, 8, 3);
  print("Monserrat Caire", 10, 9, 3);
}
